...
namespace bf {
    ...
    ShaderOpenGL::ShaderOpenGL(const std::string &name, const std::string &vertexSource,
        ...
        if (isCompiled == GL_FALSE) {
            ...
            BF_LOG_ERROR("VERTEX SHADER '{0}' COMPILATION FAILED", m_name);
        ...
        if (isCompiled == GL_FALSE) {
            ...
            // Use the infoLog as you see fit.
            BF_LOG_ERROR("FRAGMENT SHADER '{0}' COMPILATION FAILED", m_name);
            // In this simple program, we'll just leave
            return;
        }
        ...
        if (isLinked == GL_FALSE) {
            ...
            // Use the infoLog as you see fit.
            BF_LOG_ERROR("SHADER '{0}' LINKAGE FAILED", m_name);
            // In this simple program, we'll just leave
            return;
        }
